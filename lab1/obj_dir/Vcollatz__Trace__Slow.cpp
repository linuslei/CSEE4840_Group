...
void Vcollatz::traceInitThis__1(Vcollatz__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->declBit(c+25,"go", false,-1);
        vcdp->declBus(c+33,"n", false,-1, 31,0);
        vcdp->declBus(c+41,"dout", false,-1, 31,0);
        vcdp->declBit(c+49,"done", false,-1);
        vcdp->declBit(c+17,"collatz clk", false,-1);
        vcdp->declBit(c+25,"collatz go", false,-1);
        vcdp->declBus(c+33,"collatz n", false,-1, 31,0);
        vcdp->declBus(c+41,"collatz dout", false,-1, 31,0);
        vcdp->declBit(c+49,"collatz done", false,-1);
        vcdp->declBit(c+1,"collatz run", false,-1);
        vcdp->declBus(c+9,"collatz unnamedblk1 next_dout", false,-1, 31,0);
    }
}
...
void Vcollatz::traceFullThis__1(Vcollatz__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        vcdp->fullBit(c+1,(vlTOPp->collatz__DOT__run));
        vcdp->fullBus(c+9,(vlTOPp->collatz__DOT__unnamedblk1__DOT__next_dout),32);
        vcdp->fullBit(c+17,(vlTOPp->clk));
        vcdp->fullBit(c+25,(vlTOPp->go));
        vcdp->fullBus(c+33,(vlTOPp->n),32);
        vcdp->fullBus(c+41,(vlTOPp->dout),32);
        vcdp->fullBit(c+49,(vlTOPp->done));
    }
}
