...
void Vrange::traceChgThis__2(Vrange__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        vcdp->chgBus(c+1,(vlTOPp->range__DOT__state),3);
    }
}
...
void Vrange::traceChgThis__4(Vrange__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->chgBit(c+25,(vlTOPp->range__DOT__cdone));
        vcdp->chgBus(c+33,(vlTOPp->range__DOT__n),32);
        vcdp->chgBus(c+41,(vlTOPp->range__DOT__num),4);
        vcdp->chgBit(c+49,(vlTOPp->range__DOT__seen_done));
        vcdp->chgBus(c+57,(vlTOPp->range__DOT__steps),16);
        vcdp->chgBit(c+65,(vlTOPp->range__DOT__we));
        ...
        vcdp->chgBit(c+217,(vlTOPp->range__DOT__c1__DOT__run));
        vcdp->chgBus(c+225,(vlTOPp->range__DOT__c1__DOT__unnamedblk1__DOT__next_dout),32);
    }
}
...
void Vrange::traceChgThis__5(Vrange__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->chgBit(c+241,(vlTOPp->go));
        vcdp->chgBus(c+249,(vlTOPp->start),32);
        vcdp->chgBit(c+257,(vlTOPp->done));
        vcdp->chgBus(c+265,(vlTOPp->count),16);
    }
}
