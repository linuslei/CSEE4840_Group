...
void Vrange::traceChgThis__4(Vrange__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->chgBus(c+49,(vlTOPp->range__DOT__steps),16);
        ...
        vcdp->chgBit(c+209,(vlTOPp->range__DOT__c1__DOT__run));
        vcdp->chgBus(c+217,(vlTOPp->range__DOT__c1__DOT__unnamedblk1__DOT__next_dout),32);
    }
}
...
void Vrange::traceChgThis__5(Vrange__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->chgBit(c+233,(vlTOPp->go));
        vcdp->chgBus(c+241,(vlTOPp->start),32);
        vcdp->chgBit(c+249,(vlTOPp->done));
        vcdp->chgBus(c+257,(vlTOPp->count),16);
    }
}
